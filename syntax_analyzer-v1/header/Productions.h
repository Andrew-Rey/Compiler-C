...
void generateSyntax() {
    ...
    addProduction("Stmt",       {"return", "Expr", ";"});
    addProduction("Stmt",       {"return", ";"});
    addProduction("Stmt",       {"continue", ";"});
    addProduction("Stmt",       {"break", ";"});
    addProduction("Stmt",       {";"});
    addProduction("VarStmt",    {"VarDecl"});
    addProduction("VarStmt",    {"VarDef"});
    addProduction("VarStmt",    {"VarAssign"});
    addProduction("VarDecl",    {"Type", "Identifier", ";"});
    addProduction("VarDef",     {"Type", "Identifier", "=", "Expr", ";"});
    addProduction("VarAssign",  {"Identifier", "=", "Expr", ";"});
    addProduction("Expr",       {"RelationExpr"});
    addProduction("Expr",       {"OperationExpr"});
    addProduction("Expr",       {"Identifier", "(", ")"});
    addProduction("Expr",       {"Identifier", "(", "IdentList", ")"});
    addProduction("IdentList",  {"Identifier"});
    addProduction("IdentList",  {"Identifier", ",", "IdentList"});
